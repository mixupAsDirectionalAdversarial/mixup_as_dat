...
if __name__ == '__main__':
    ...
    parser.add_argument('--gamma_parameters', default=(1., 1.), type=float, nargs=2,
                        help='parameters of gamma function (Beta CDF) -- default is vanilla mixup ie gamma(lambda)=lambda. Only used if --dat_transform NOT supplied.')
    ...
    parser.add_argument("--disable_sanity_learning_rate", dest='sanity_learning_rate', help="use original author's learning rate drops at 100/150",
                        action="store_false")
    ...
    parser.add_argument("--disable_iid_sampling", dest='iid_sampling', help="iid: sample the second datapoint as an i.i.d instead of batch-wise",
                        action="store_false")
    ...
    # for normalization values method: https://discuss.pytorch.org/t/normalization-in-the-mnist-example/457/12?u=gobbedy
    ...
    if args.augment:
        transform_train = transforms.Compose([
            transforms.RandomCrop(side_length, padding=4),
    ...
    if args.dataset == 'cifar10':
        ...
        trainset = datasets.FashionMNIST(root='~/data/fashion', train=True, download=True,
                                         transform=transform_train)
    ...
    if args.dataset == 'cifar10':
        ...
        testset = datasets.FashionMNIST(root='~/data/fashion', train=False, download=False,
                                         transform=transform_train)
    ...
    net = models.__dict__[args.model](num_channels, num_classes, args.cosine_loss, args.label_dim)
